# Generated by Django 4.1.4 on 2023-04-03 11:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(default=2019, verbose_name='Возраст')),
                ('country', models.CharField(max_length=20, verbose_name='Страна')),
                ('world_premiere', models.PositiveIntegerField(default=datetime.date(2023, 4, 3), verbose_name='Премьера в мире')),
                ('budget', models.PositiveIntegerField(default=0, help_text='указывать сумму в долларах', verbose_name='Бюджет')),
                ('fees_in_usa', models.PositiveIntegerField(default=0, help_text='указывать сумму в долларах', verbose_name='Сборы в NoneСША')),
